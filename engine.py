...
5. Use referências em sobrescrito: ¹, ², ³, ... e numere-as na ordem de primeira aparição no texto. Se uma referência já utilizada for citada novamente, reutilize o mesmo número original. Não use colchetes [1] nem outras marcas de citação.
